...
exports.todo = {};
exports.todo.get = async function(todo_text, guild_id, user_id) {
    ...
    quer =  "SELECT todo_index, todo_text " +
            "FROM buttbot.todo ";

    if (conditions.length > 0) {
        quer = quer + "WHERE " + conditions[0];
...
//TODO: add, delete, top (add to get), next (add to get), pending, approve, deny
